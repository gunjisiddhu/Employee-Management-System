...
public class EmployeeProj extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b1) {
            try {
                String sql = "select p.name,w.name from projectInfo p,working w where w.pid = p.pid and w.username=?";
